...
function SingleSelectDropDown({ handleSelectChange, selectedType, options, placeholder = "", target = "", creatableSelect, isClearable = true, isDisabled = false, iscapitalize = false, menuPlacement="bottom" }) {
