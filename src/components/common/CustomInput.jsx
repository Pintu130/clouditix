...
function CustomInput({ label = "", placeholder = "", name = "", value = "", onChange, errors = "", isRequired = false, isIcon = false, isNUmber = false, isDisabled = false }) {
    return (
        <div className="relative flex flex-col w-full gap-1">
            ...
            <input
                ...
                disabled={isDisabled} // Using isDisabled prop
