...
import {
  ...
  setIdentificationDataUpdate,
} from "@/store/guestDataCreateSlice";
...
const IdentificationModel = ({
  ...
  // console.log("🚀 ~ IdentificationModel ~ formDataName:", formDataName);
  ...
  const HandleSave = () => {
    if (Object.keys(updateRowData).length > 0) {
      const updatedata = rowData?.map((item) =>
        item.identificationId === updateRowData.identificationId
          ? identification
          : item
      );
  ...
  useEffect(() => {
    if (updateRowData && Object.keys(updateRowData).length > 0) {
      const convertData = {
        ...
        identificationType: {
          label: updateRowData?.identificationType,
          value: updateRowData?.identificationType,
        },
        identificationValue: updateRowData?.identificationValue,
        issuingCountry: {
          label: updateRowData?.issuingCountry,
          value: updateRowData?.issuingCountry,
        },
            ...
            <div className="flex items-center gap-5">
              ...
              <div className=" w-full md:w-[200px] ]">
                <CustomInput
                  ...
                  onChange={(e) =>
                    handleidentificationData(e.target.name, e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between gap-5 h-full">
            <div className=" w-full flex flex-col md:flex-row items-center justify-between gap-5">
              <div className=" w-full flex flex-col items-center justify-center gap-3">
                <div className=" w-full flex items-start justify-start flex-col   gap-2 ">
                  <label className="flex items-center w-full  xl:max-w-[160px]">
                    Identification Type
                  </label>
                  <div className=" w-full md:w-[250px] lg:w-full xl:w-[300px] ]">
                    <SingleSelectDropDown
                      ...
                      handleSelectChange={(data) =>
                        handleidentificationData("identificationType", data)
                      }
                    />
                  </div>
                </div>
                ...
                <div className=" w-full flex items-start justify-start flex-col  gap-2 ">
                  ...
                  <div className=" w-full md:w-[250px] lg:w-full xl:w-[300px] ]">
                    <SingleSelectDropDown
                      ...
                      handleSelectChange={(data) =>
                        handleidentificationData("issuingCountry", data)
                      }
                    />
                  </div>
                </div>
                    ...
                    <input
                      ...
                      value={
                        identification?.expiryDate
                          ? identification?.expiryDate.split("T")[0]
                          : ""
                      }
                      onChange={(e) =>
                        handleidentificationData(e.target.name, e.target.value)
                    ...
                    <input
                      ...
                      value={
                        identification?.issueDate
                          ? identification.issueDate.split("T")[0]
                          : ""
                      }
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-5 pb-5">
              <div className="w-full flex gap-4 ">
                <label className="flex items-center xl:max-w-[160px] ">
                  Is Active
                </label>
                <input
                  type="checkbox"
                  ...
                  onChange={(e) =>
                    handleidentificationData(e.target.name, e.target.checked)
                  }
